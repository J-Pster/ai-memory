...
Scenario walkthroughs (cross-agent handoffs, six-weeks-later recall,
running one server for the whole household, and more) are in
[docs/use-cases.md](docs/use-cases.md); importing an existing memory
tool is covered in
