...
async fn main() -> Result<()> {
    ...
    match command {
        ...
        Command::DeletePages(args) => commands::delete_pages::run(&config, args).await,
        ...
        Command::Import(args) => commands::import::run(&config, args).await,
        Command::ImportInstructions => commands::import_instructions::run(),
        Command::Rehome(args) => commands::rehome::run(&config, args).await,
